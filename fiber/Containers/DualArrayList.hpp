...
namespace fiber
{
    ...
    public:
        ...
        constexpr reference left_front(){
            FIBER_ASSERT_O1(!this->left_empty());
        ...
        constexpr reference right_front(){
            FIBER_ASSERT_O1(!this->right_empty());
        ...
        constexpr reference left_at(const UInt i){
            FIBER_ASSERT_O1(fiber::less(i, this->left_size()));    
        ...
        constexpr reference right_at(const UInt i){
            FIBER_ASSERT_O1(fiber::less(i, this->right_size()));
        ...
        constexpr reference left_at(SInt si){
            FIBER_ASSERT_O1(fiber::less(si, this->left_size()));
            FIBER_ASSERT_O1(fiber::less_equal(-si, this->left_size()));
        ...
        constexpr reference right_at(SInt si){
            FIBER_ASSERT_O1(fiber::less(si, this->right_size()));
            FIBER_ASSERT_O1(fiber::less_equal(-si, this->right_size()));
        ...
        constexpr left_iterator left_unconst(const left_const_iterator pos) {
            FIBER_ASSERT_O1(this->left_begin() <= pos);
            FIBER_ASSERT_O1(pos <= this->left_end());
            return this->left_begin() + this->left_to_index(pos);
        }

        constexpr right_iterator right_unconst(const right_const_iterator pos) {
            FIBER_ASSERT_O1(this->right_begin() <= pos);
            FIBER_ASSERT_O1(pos <= this->right_end());
        ...
        left_iterator left_insert(const left_const_iterator pos, Itr first, Itr last){
            ...
            FIBER_ASSERT_O1(fiber::less_equal(dist, this->reserve()));
        ...
        left_iterator left_erase(left_const_iterator first, left_const_iterator last){
            FIBER_ASSERT_O1(this->left_begin() <= first);
            FIBER_ASSERT_O1(first <= this->left_end());
            FIBER_ASSERT_O1(this->left_begin() <= last);
            FIBER_ASSERT_O1(last <= this->left_end());
        ...
        right_iterator right_erase(right_const_iterator first, right_const_iterator last){
            FIBER_ASSERT_O1(this->right_begin() <= first);
            FIBER_ASSERT_O1(first <= this->right_end());
            FIBER_ASSERT_O1(this->right_begin() <= last);
            FIBER_ASSERT_O1(last <= this->right_end());
