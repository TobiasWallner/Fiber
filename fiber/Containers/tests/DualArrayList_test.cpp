...
#include <fiber/Containers/DualArrayList.hpp>
...
namespace fiber{
    ...
    namespace{
        ...
        fiber::TestResult insert_value_by_proxy(){
            TEST_START;
        ...
        fiber::TestResult insert_range_by_proxy(){
            TEST_START;
