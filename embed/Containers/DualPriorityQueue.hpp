...
namespace embed
{
    ...
    public:
        ...
        void stage1_push(const T& value){
            ...
            std::push_heap(this->stage1().begin(), this->stage1().end(), stage1_greater_priority{});
        }
        ...
        void stage2_push(const T& value){
            ...
            std::push_heap(this->stage2().begin(), this->stage2().end(), stage2_greater_priority{});
        }
        ...
        void stage2_pop(){
            std::pop_heap(this->stage2().begin(), this->stage2().end(), stage2_greater_priority{});
            this->stage2().pop_back();
        }

        void stage1_pop(){
            std::pop_heap(this->stage1().begin(), this->stage1().end(), stage2_greater_priority{});
    ...
    class Stage1DualPriorityQueueConstRef{
        private:
        const DualPriorityQueue<T, N, stage1_greater_priority, stage2_greater_priority>& _queue;
        ...
        Stage1DualPriorityQueueConstRef(const DualPriorityQueue<T, N, stage1_greater_priority, stage2_greater_priority>& queue)
            : _queue(queue){}
    ...
    class Stage1DualPriorityQueueRef{
        ...
        Stage1DualPriorityQueueRef(DualPriorityQueue<T, N, stage1_greater_priority, stage2_greater_priority>& queue)
            : _queue(queue){}
    ...
    class Stage2DualPriorityQueueConstRef{
        ...
        Stage2DualPriorityQueueConstRef(const DualPriorityQueue<T, N, stage1_greater_priority, stage2_greater_priority>& queue)
            : _queue(queue){}
    ...
    class Stage2DualPriorityQueueRef{
        ...
        Stage2DualPriorityQueueRef(DualPriorityQueue<T, N, stage1_greater_priority, stage2_greater_priority>& queue)
            : _queue(queue){}
