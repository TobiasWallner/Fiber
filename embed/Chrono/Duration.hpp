...
namespace embed
{
    ...
    /*
    Define the representation: `EMBED_CLOCK_UINT<x>`
    Define the frequency with: `EMBED_RTC_FREQ_HZ`
    */
     ...
     */
    class Duration : public std::chrono::duration<Tick<DurationRepresentation>, std::ratio<1, EMBED_RTC_FREQ_HZ>>{
        public:
        using base = std::chrono::duration<Tick<DurationRepresentation>, std::ratio<1, EMBED_RTC_FREQ_HZ>>;
